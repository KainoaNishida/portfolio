      ...
      <div className="container-content">
        ...
        <div className="mb-16">
          ...
          <div className="mx-auto max-w-3xl md:max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 justify-items-start">
              <div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <ul className="space-y-6 text-slate-600 dark:text-slate-400">
            ...
            <li>
              <div className="mb-2">
                <h4 className="text-lg font-bold text-slate-900 dark:text-white inline">CS 161: Design and Analysis of Algorithms</h4>
                <span className="mx-2">•</span>
                <span className="text-orange-600 dark:text-orange-400">Learning Assistant</span>
                <span className="mx-2">•</span>
                <span className="text-sm">Professor Schindler</span>
              </div>
              <ul className="list-disc list-inside pl-4">
                <li>Assisting students with algorithm design and complexity analysis</li>
              </ul>
            </li>
