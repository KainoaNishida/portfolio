...
2. Click **Add Domain**
3. Enter `kainoanishida.com` and `www.kainoanishida.com`
...
- [ ] Test the site at `https://kainoanishida.com`
- [ ] Test the site at `https://www.kainoanishida.com`
- [ ] Verify Spotify API is working (check browser console)
- [ ] Test all pages and navigation
- [ ] Verify HTTPS is enabled (should be automatic on Vercel/Netlify)
